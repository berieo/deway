...
Window {
    ...
    property int indexPage: 0x00;    // 故障代码生成器的页面状态值，确定当前所在的页面
    ...
    Column {
        id: mainRow;
        width:win.width;
        height: win.height-84/screenRate;
        ...
        Rectangle {
            ...
            Image
            {
                width: 500/screenRate
                height: 500/screenRate
        ...
        Item{
            ...
            Row{
                ...
                //Rectangle { width: 2; height: parent.height; }
                Item {
                    width: (parent.width)/4;
                    height: parent.height;
                    z: indexPage==1 ? 5:3;
        ...
        Item{
            ...
            Row{
                ...
                //                    Image {
                //                        anchors.fill: parent;
                //                        source: indexPage==3 ? tabSel : tabSeless;
                //                    }
                //                    Text{
                //                        anchors.fill: parent;
                //                        verticalAlignment: Text.AlignVCenter;
